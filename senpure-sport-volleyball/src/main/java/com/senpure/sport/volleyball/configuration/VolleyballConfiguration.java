...
public class VolleyballConfiguration {
    ...
    public VolleyballConfiguration (RestTemplateBuilder restTemplateBuilder, List<RestTemplateCustomizer> restTemplateCustomizers) {
    ...
    @Bean
    public VolleyballRoomManager volleyballRoomManager() {
        ...
        return new VolleyballRoomManager(rangeValue.getStart().intValue(), rangeValue.getEnd().intValue());
    }
}
