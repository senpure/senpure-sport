...
import com.senpure.dispatcher.criteria.ServerCenterAndWorkCriteria;
import com.senpure.dispatcher.mapper.DispatcherLockMapper;
import com.senpure.dispatcher.mapper.ServerCenterAndWorkMapper;
...
public class SnowflakeDispatchServiceMysqlImpl implements SnowflakeDispatchService, ApplicationRunner {
    ...
    public ServerCenterAndWork dispatch(String serverName, String serverKey) {
       DispatcherLock lock = lockMapper.find(1L);
        if (lock == null) {
